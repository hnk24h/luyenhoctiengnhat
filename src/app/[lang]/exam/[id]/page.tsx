  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center gap-2 mb-4 text-sm text-gray-500">
        <Link href={`/${params.lang}/levels`} className="hover:text-red-600">Cấp độ</Link>
        <span>/</span>
        <Link href={`/${params.lang}/levels/${examSet.level.code}`} className="hover:text-red-600">{examSet.level.code}</Link>
        <span>/</span>
